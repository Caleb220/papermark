...
export function FeedbackModal({
  ...
  const getSubtitle = () => {
    ...
    switch (reason) {
      ...
      case "unused":
        return "Help us understand how we can make Odinkor more valuable for your workflow.";
      case "missing_features":
  ...
  const getPlaceholder = () => {
    ...
    switch (reason) {
      ...
      case "unused":
        return "Share how you use Odinkor and what would make it more valuable...";
      case "missing_features":
