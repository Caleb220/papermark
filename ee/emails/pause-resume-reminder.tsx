...
const baseUrl =
  process.env.NEXT_PUBLIC_MARKETING_URL || "https://www.odinkor.com";
          ...
          <Container className="mx-auto my-[40px] w-[465px] rounded border border-solid border-[#eaeaea] p-[20px]">
            ...
            <Section className="mt-[32px] border-t border-solid border-[#eaeaea] pt-[20px]">
              <Text className="text-[12px] leading-[16px] text-[#666]">
                ...
                team on Odinkor. If you believe this was sent in error, please
                contact our support team.
              </Text>

              <Text className="text-[12px] leading-[16px] text-[#666]">
                Odinkor - The secure document sharing platform
              </Text>
            </Section>
          </Container>
        </Body>
