...
export default function CustomDomainSetup({
  ...
  return (
    <Html>
      <Head />
      <Preview>Your Odinkor custom domain set up</Preview>
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 w-[465px] p-5">
            ...
            <ol className="list-inside list-decimal text-sm">
              ...
              <li>Add a CNAME record pointing to odinkor.com</li>
              <li>Configure the domain in your Odinkor settings</li>
            ...
            <Text className="text-sm leading-6 text-black">
              {hasAccess ? (
                <>
                  ...
                  <Link
                    href="https://docs.odinkor.com/custom-domains"
